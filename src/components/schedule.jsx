...
// Add inside your existing component:
const { addAppointment } = useAppointments();

// Modify your existing submit/book function:
const handleSubmit = (e) => {
  e.preventDefault();
  
  // Create appointment object from your form data
  ...
  // Add to context and localStorage
